...
# ╔═╡ 3c25d5ad-f53f-48a3-89ea-5392d0b9202a
using IntervalArithmetic, LinearAlgebra, Symbolics, Random


# ╔═╡ 76d6613f-ff5e-4581-b441-f5d5e12ad482
begin
...
# ╔═╡ a475da6c-a3bb-11ed-3431-3397b73d1508
localFunctions = ingredients("automaton.jl")

# ╔═╡ 42a4a19a-aa99-48b0-9ccb-4a99fd268709
tri = localFunctions.buildFundTriangle(3,3,4)

# ╔═╡ 24623a34-d2ea-40cb-bd9f-14ec4f8ad3c0
localFunctions.findWord(0,0.1,localFunctions.dummyAuto,tri)

# ╔═╡ e32f8d83-e34c-47cd-a676-331c5221f4c9
begin
	...
	function bench()
		...
		lengths = zeros(0)
	    for i in x
	        s = localFunctions.findWord(i,
									i+prec,
									localFunctions.dummyAuto,
									tri)
			lengths = append!([length(s)],lengths)
	    end
		return lengths
	end
end
...
# ╔═╡ b0d65a09-de95-4160-84a6-7f1e792a58ad
@time L = bench()

# ╔═╡ 05e270f8-3936-493d-a251-afe851a0b38d
minimum(L), maximum(L)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "da3d8d2274f782a326899c8177c4f0e19041f039"
