...
begin
	using IntervalArithmetic, LinearAlgebra, Symbolics, DataStructures
...
function buildNewIntervals(cannonthurston::DataStructures.SortedDict, precision = 10^-1)
	max_distance = 0
	NewIntervals = []
...
function IterativeConstruction(startIntervals, rep, automat, triangle)
	...
	control = 1
	while length(Intervals)>0 && control < 15
		print("$(control) \n")
		control += 1
		enrichCannonThurston(Intervals, CannonThurston, rep, automat, triangle)
...
# ╔═╡ 9b4fcd6d-7dd6-48ce-ac5b-11f9dcd9b195
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "6e3c33e1a837bb8ae7c5744613ef6a3742a2d674"
